...
\begin{proof}
    ...
    \begin{lem}
        ...
        \end{proof}
    \end{lem}
    Consider steps $t_0+1,...,t_1-1$, all cups are initially $<1$ and consider only cups that go above $2$. The number of such cups is $\leq O(\log n)$ as $t_1-t_0=O(\log n)$ with high probability.  
\end{proof}
\end{document}
...
\end{thm}
\begin{rmk}
    One potential approach that is incorrect is instead of candidates being median $\theta( \frac{t}{\log n})$ elements in subproblem we choose it to be median $\frac{t}{100 \sqrt{\log n \log \log n}}$
\end{rmk}
\end{document}
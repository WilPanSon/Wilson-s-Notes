...
\end{rmk}
\begin{proof}
    The fix is that if density(subproblem)$\notin [\frac{1}{4}, \frac{3}{4}]$ revert back to using the $O(\log ^2 n)$ solution on this subproblem and all of its descendents. Call this subproblem and its descendents 
\end{proof}
\end{document}
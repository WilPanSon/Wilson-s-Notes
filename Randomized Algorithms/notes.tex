...
\begin{proof}
    ...
    \begin{claim}
        ...
        This is shown by \# such $j=\sum$ independent 0-1 RV with mean $\geq \frac{c \log n}{10}$ implies by Chernoff bound that with high probability, $\geq \frac{c \log n}{20}$ such $j$ exist. 
    \end{claim}
\end{proof}
\end{document}
...
\begin{proof}
    ...
    \Pr[S_{i,j} \text{misses }B(x,r_i)]\geq \left( 1-\frac{1}{2^i} \right)^{2i}\approx \frac{1}{e} \implies \Pr[S_{i,j} \text{ hits }B(x,r_i)]\leq 1- \left( 1-\frac{1}{2^i} \right)^{2i}\approx 
    .\] 
\end{proof}
\end{document}
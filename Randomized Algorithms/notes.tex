...
\end{prop}
\begin{rmk}
    The greedy algorithm for the emptier is to empty up to $1$ unit from fullest cup. This was proven in 1987 by Dietz/Slaeator where Greedy achieves backlog of $O(\log n)$ and the filler can force backlog $$
\end{rmk}
\end{document}
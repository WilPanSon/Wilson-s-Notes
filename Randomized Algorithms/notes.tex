...
\end{thm}
\begin{proof}
    Define $Y_1=\E[f|X_1]-\E[f]$, $Y_2=\E[f|X_1,X_2]-\E[f|X_1]$ and in general $Y_i=\E[f|X_1,...,X_i]-\E[f|X_1,...,X_{i-1}]$. Then we have $\E[Y_i]=0$ and $|Y_i|\leq 1$. So by Azuma's Inequality we have \[
\end{proof}
\end{document}
...
\begin{eg}
    Soft Thresholding: \[
    x^*=\arg\min_{z\in \R^d} \frac{1}{2}||z-y||_2^2+\lambda||z||_1
    .\]
    ...
    \[
        ...
        \end{cases}
    .\] 
    We have $0\in x^*-y+\lambda \text{sign}(x^*)$. 
    So \[
    x_j^*= \begin{cases}
        y_j-\lambda & \text{if $y_j\geq \lambda$} \\
        y_j+\lambda & \text{if $y_j\leq -\lambda$}\\
        0 & \text{otherwise}
    \end{cases}
    .\] 
\end{eg}
\begin{thm}
    Proxiaml Gradient Descent: Our objective is \[

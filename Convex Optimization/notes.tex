...
For any $a,b,c \geq 0$ with $a+b=p$ and $a+c=q$, we have
\[
    \min_{x,y} px + qy \geq 2a \quad \text{subject to } x+y \geq 2,\; x,y \geq 0
\]
\textbf{What's the best we can do?} Maximize our lower bound over all possible $a,b,c$:
\begin{center}

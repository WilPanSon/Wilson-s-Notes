...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=1.1, >=Stealth]
        ...
        % f(x_T^best) - f(x^*) = optimality gap
        \draw[dashed, red] (0.5, 0.2) -- (0.5, 0);
        \draw[<->, red!80!black] (0.5, 0.1) -- (0, 0.1);
        \node[red!80!black, font=\footnotesize, above] at (0.25, 0.15) {$\leq$ bound};
        % Formula callout

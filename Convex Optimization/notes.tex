...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=1.2, >=Stealth]
        % Convex set C
        \fill[gray!15] (0.5, 0.5) -- (2.5, 0.3) -- (3, 1.5) -- (1.5, 2.2) -- (0.2, 1.5) -- cycle;
        \draw[thick] (0.5, 0.5) -- (2.5, 0.3) -- (3, 1.5) -- (1.5, 2.2) -- (0.2, 1.5) -- cycle;
        \node at (1.5, 1.2) {$C$};
        % x_1, x_2 (outside C)
        \fill (0.3, 2.3) circle (2pt);
        \node[above left] at (0.3, 2.3) {$x_1$};
        \fill (3.2, 0.8) circle (2pt);
        \node[above right] at (3.2, 0.8) {$x_2$};
        % z_1 = P_C(x_1), z_2 = P_C(x_2)
        \fill[red!80!black] (0.65, 1.6) circle (2.5pt);
        \node[below left, red!80!black] at (0.65, 1.6) {$z_1=P_C(x_1)$};
        \fill[red!80!black] (2.6, 0.9) circle (2.5pt);
        \node[below right, red!80!black] at (2.6, 0.9) {$z_2=P_C(x_2)$};
        % Projection lines (x_i to z_i)
        \draw[dashed] (0.3, 2.3) -- (0.65, 1.6);
        \draw[dashed] (3.2, 0.8) -- (2.6, 0.9);
        % ||x_1 - x_2|| (long segment)
        \draw[thick, blue!70!black] (0.3, 2.3) -- (3.2, 0.8);
        \node[above, blue!70!black, font=\small] at (1.75, 1.55) {$\lVert x_1 - x_2 \rVert$};
        % ||z_1 - z_2|| (shorter segment inside C)
        \draw[thick, red!80!black] (0.65, 1.6) -- (2.6, 0.9);
        \node[below, red!80!black, font=\small] at (1.625, 1.25) {$\lVert z_1 - z_2 \rVert \leq \lVert x_1 - x_2 \rVert$};
    \end{tikzpicture}
    \caption{Projection is a contraction: the distance between projections $\lVert P_C(x_1) - P_C(x_2) \rVert$ is at most the distance $\lVert x_1 - x_2 \rVert$.}
\end{figure}

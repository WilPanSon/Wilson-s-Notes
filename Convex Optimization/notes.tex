...
\end{rmk}
\begin{thm}
    Strong Duality: If the primal is feasible and bounded, then the dual is feasible and bounded, and the optimal values of the primal and dual problems are equal.
\end{thm}
\end{document}

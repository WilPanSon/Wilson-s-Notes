...
\begin{defn}
    At a high level, it gives you, every dual feasible point gives a provable lower bound of the original primal problem, even if the original (primal) problem is non-convex. )
\end{defn}
\end{document}

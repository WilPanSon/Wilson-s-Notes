...
\begin{center}
  ...
  \vspace{0.5em}
  \vspace{1em}
  \textsc{\large CMU 10-725: Optimization for Machine Learning} \\
  \vspace{0.5em}
%\url{https://piazza.com/cmu/spring2023/10725/home} \\
  \vspace{0.5em}
  \centerline{OUT: Tuesday, Jan 20th, 2026}
  \vspace{0.5em}
  \centerline{DUE: Tuesday, February 3rd, 2026, 11:59pm}
\end{center}
...
\newcommand{\Tian}[1]{\textcolor{blue}{[Tian: #1]}}
% \newcommand{\Tian}[1]{}

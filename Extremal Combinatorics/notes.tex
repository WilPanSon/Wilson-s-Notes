...
\end{proof}
\begin{thm}
    $H$ is a $k$-uniform hypergraph. A sunflower with $r$ petals is a collection $f_1,...,F_r\in H$ such that $\exists k$ such that each $f_i$ is $f_i'\cup k$ for some $f_i'$ with $f_i'\cap f_j'=\emptyset$ 
\end{thm}
\end{document}
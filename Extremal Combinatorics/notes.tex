...
\end{lem}
\begin{proof}
    Pick $\epsilon'=$ and apply szemeredi's regularity lemma to $G$ to get an $\epsilon$-regular partition $V(G)=V_1\cup \cdots \cup V_k \cup J$ where $m\leq k\leq M(\epsilon', m)$
\end{proof}
\end{document}
...
\begin{proof}
    ...
    What really matters is that given $(X,F)$, let $t_A(F)=\# \{f\cap A | f\in F\}$ where $A$ is the set of our sample points $x_1,...,x_n,y_1,...,y_n$. \\
    In our argument, for $F=$ axis parallel rectangles, $t_A(F)\leq |A|^4$. We just need this to be polynomial. 
\end{proof}
\end{document}
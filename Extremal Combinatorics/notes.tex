...
\begin{proof}
    ...
    f(\mathcal{P}')\geq f(\mathcal{P})+\sum_{\substack{w'\in \mathcal{P}' \\ w' \text{ is } \epsilon\text{-irregular}}}\sum_{w^{(2)}}(d(w^{(2)})-d(w'))^2\frac{|w^{(2)}|}{|w|}\geq f(\mathcal{P})+\sum_{\substack{w'\in \mathcal{P}' \\ w' \text{ is } \epsilon\text{-irregular}}}\epsilon^2 \frac{\epsilon |w'|}{|w|}=f(\mathcal{P})+\epsilon^4
    .\] 

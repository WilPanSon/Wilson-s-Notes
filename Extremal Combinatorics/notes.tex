...
\newpage
\begin{thm}
    Helly's Theorem: In $\R^d$, if convex sets $A_1,...,A_m\in \R^d$ have the property that any $d+1$ sets have nonempty intersection then $A_1\cap \cdots \cap A_n$ is nonempty. 
\end{thm}
\begin{rmk}

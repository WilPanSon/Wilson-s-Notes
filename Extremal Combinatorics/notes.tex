...
\end{thm}
\begin{proof}
    By induction on $n$, let $d_F<\infty$ be VC-dim of $F$. Now to show $\forall A, t_F(A)\leq \sum_{j=0}^{d_F}{|A| \choose j}$. WLOG, let $A=[n]$, $t_F(A)=|F_{[n]}|$ where $F_{[n]}=\{f\cap [n] | f\in F\}$.
\end{proof}
\end{document}
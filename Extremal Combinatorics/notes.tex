...
\end{conj}
\begin{lem}
    Auxillary Hypergraph: Consider a $t(n,r,1)$ design $B$ on $[n]$. Define a hypergraph $H$ as follows $V(H)= \binom{[n]}{t}$. Edges of $H$ are as follows: For each $r$-subset of $[n]$, we define an edge of $H$ consisting of all $t$-subsets 
\end{lem}
\end{document}
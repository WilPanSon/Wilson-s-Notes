...
\begin{defn}
    \[
    \pi(F):=\lim_{h\to \infty}\frac{ex(n,F)}{{n \choose 2}}
    .\] 
...
\begin{thm}
    ...
    \begin{proof}
        Let $n_0$ be large enough such that $\frac{ex(n,F)}{{n \choose 2}}\leq \pi(F)+\frac{\epsilon}{2}.$ Given $n$-vertex $G$ as in theorem. Pick $n_0$ vertices at random without replacement. Let $G'$ be the $n_0$-vertex graph induced on these chosen vertices. \[

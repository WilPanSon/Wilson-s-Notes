...
\begin{proof}
    ...
    Edge disjointness implies to kill all $\triangle$'s in $G$ we need to delete at least $|A|=\beta n^2$ edges. By triangle removal the number of $\triangle$'s in $G$ is at least $\delta(\beta) n^3$. 
\end{proof}
\end{document}
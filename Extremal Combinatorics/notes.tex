...
\end{lem}
\begin{proof}
    Let $X= \{(A',A)\in \partial \mathcal{A}\times \mathcal{A}: A'\subset A\}$ then be the number of edges in the bipartite graph between $\mathcal{A}$ and $\mathcal{A}'$. We have $|X|=|\mathcal{A}|\cdot k$
\end{proof}
\end{document}
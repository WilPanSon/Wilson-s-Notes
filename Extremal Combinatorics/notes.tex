...
\end{thm}
\begin{proof}
    Assume WLOG $0\in CH(x_1,...,x_m)$ but not in $CH(x_{i_1},...,x_{i_{d+1}})$. For any $| \{i_1,...,i_{d+1}\}=d+1$. For any $x_i,$ define $H_i= \{v| v\cdot x_i\geq 1\}$. For any choice of $x_{i_1},...,x_{i_{d+1}}$ 
\end{proof}
\end{document}
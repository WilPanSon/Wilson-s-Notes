...
\begin{proof}
    ...
    WLOG we'll show $q\in H_1$ and WLOG assume $p_1\in \bigcap_{2\leq j\leq m}H_j$ got colored blue by Radon. Then all the red points $p_j\in $Red are in $H_1$. Since $H_i$ is convex, $q\in CH(Red)\$ 
\end{proof}
\end{document}
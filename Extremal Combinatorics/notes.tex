...
\begin{proof}
    ...
    \begin{aligned}
        &\leq \underbrace{\binom{\binom{n}{2}}{\epsilon n^2}}_{\text{deleted edges}} \\
        &\quad \cdot \underbrace{(2^n)^k}_{\text{choices for }V_1,\dots,V_k} \\
        &\quad \cdot \underbrace{2^{(n/k)^2\cdot e(R)}}_{\text{choices of edges between regular parts}}
    \end{aligned}
    \]
\end{proof}
\end{document}
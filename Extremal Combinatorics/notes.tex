...
\begin{proof}
    ...
    .\] 
    Let $A=a_1+...+a_k$ then $\frac{a_1}}p_1+\cdots+\frac{a_k}{A}p_k$ is a convex combination of red points so it's in the convex hull of the red points. We now want to show that this is also in the convex hull of the blue points. 
\end{proof}
\end{document}
...
\begin{proof}
    ...
    If $x\in \mathcal{F}\setminus \mathcal{A}$ and $y\in \partial \mathcal{A}$ then $|X|\leq |Y|$. So if $X$ and $Y$ were comparable then $X\subset Y$. So if $Y\in \partial \mathcal{A}$ then $\exists Z\in \mathcal{A}, Y\subset Z$
\end{proof}
\end{document}
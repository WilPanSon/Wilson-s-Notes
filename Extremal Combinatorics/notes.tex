...
\end{claim}
\begin{lem}
    Letting $\lambda_j:=\lambda \binom{n-j}{t-j}/\binom{r-j}{t-j}$ then for $\lambda_0=|B|=(\binom{n}{t})/\binom{r}{t}$ and $\lambda_1= \text{degree of a vertex}=(\binom{n-1}{t-1})/\binom{r-1}{t-1}$
\end{lem}
\begin{thm}

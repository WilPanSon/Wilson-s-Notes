...
\begin{proof}
    ...
    (Induction Step): Given $H_1,...,H_{m}$. Given $m\geq d+2$ sets, any $d+1$ intersect. By base case, any $d+2$ intersect. Define $H_1'=H_1,H_2'=H_2,...,H_{m-2}'=H_{m-2}$ and $H_{m-1}'=H_{m-1}\cap H_m$. 
\end{proof}
\end{document}
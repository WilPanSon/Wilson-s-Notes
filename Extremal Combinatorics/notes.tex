...
\begin{proof}
    ...
    .\] 
    On each line the two intervals are disjoint and so at most one is in $\mathcal{A}\cap \mathcal{F}$. 
    \[
    \begin{aligned}
    \E[|\mathcal{A}\cap \mathcal{F}|]&=\sum_{A\in \mathcal{F}} \Pr[A\in \mathcal{A}]=\frac{|\mathcal{F}|}{\binom{n}{k}}\cdot n\\
    &\Downarrow\\
    \frac{|\mathcal{F}|}{\binom{n}{k}}\cdot n&\leq k\implies |\mathcal{F}|\leq \binom{n-1}{k-1}
    \end{aligned}
    \] 

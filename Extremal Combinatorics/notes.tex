...
\end{thm}
\begin{thm}
    Corner Theorem: $\forall \beta>0$ and $A\subset [n]^2$ with $|A|\geq \beta n^2$ and $n\geq n_0(\beta)$ then $A$ contains a ``corne'' which is a set of the form $(x,y),(x+d,y),(x,y+d)$ with $d\neq 0$
\end{thm}
\begin{rmk}

...
\section{(Feb 20)}
\begin{thm}
    Sligth Generalization of Triangle Counting Lemma: If $X,Y,Z$ are disjoint subsets of $V(G), (X,Y),(X,Z),(Y,Z)$ are $\epsilon$-regular hten $G$ contains $K_{t,t,t}$, $\d(X,Y),d(X,Z),d(Y,Z)\geq \alpha$ and $\epsilon<\epsilon_0(\alpha, t).$ 

...
\begin{thm}
    Roth's Theorem: If $A\subset [n]$ of density at least $\alpha>0$ (i.e. $|A|\geq \alpha n$) and $n\geq n_0(\alpha)$ then $A$ contains a 3-term arithmetic progression i.e., a set of the form $x,x+d,x+2d$ with $d\neq 0$
\end{thm}
\begin{rmk}

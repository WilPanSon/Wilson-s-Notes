...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \end{align*} 
        \item Cut each of the parts in $\mathcal{P}_{ \text{new}}$ into equally big parts so total \# parts is $\leq k\cdot 4^k$ and some left over where \# of leftovers is $\leq $
    \end{enumerate} 
\end{proof}
\end{document}
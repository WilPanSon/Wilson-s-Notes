...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            &\geq f(\mathcal{P})+\frac{\epsilon^4}{2}
        \end{align*} 
        \item Cut each of the parts in $\mathcal{P}_{ \text{new}}$ into equally big parts so total \# parts is $\leq k\cdot 4^k$ and some left over where \# of leftovers is $\leq k 2^k$ and the size of them $\leq $
    \end{enumerate} 
\end{proof}
\end{document}
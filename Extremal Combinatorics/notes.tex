...
\end{rmk}
\begin{proof}
    Corner Theorem: Define a tripartite graph with parts $V,H,D$ where the vertices of $V$ are all vertical lines through $[n]^2$ and the vertices of $H$ are all horizontal lines through $[n]^2$ and the vertices of $D$ are all diagonal lines through $[n]^2$. 
\end{proof}
\end{document}
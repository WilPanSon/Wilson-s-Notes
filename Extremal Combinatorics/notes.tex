...
\end{thm}
\begin{defn}
    Affine Dependence: Given $p_1,...,p_n\in \R^d$, they are affinely dependent iff $p_1-p_n,p_2-p_n,...,p_{n-1}-p_n$ are linearly dependent iff $\exists a_1,...,a_{n-1}$ such that $a_1(p_1-p_n)+...+a_{n-1}(p_{n-1}-p_n)=0$. 
\end{defn}
\end{document}
...
\end{defn}
\begin{defn}
    $(2^{[n]},\subset)$ is a partially order set (poset). 
\end{defn}
\begin{defn}
    If $(P,\succeq)$ is a poset, a chain is a set $C\subset P$ such that $\forall x,y\in P, x\succeq y$ or $y\succeq x$. 
\end{defn}
\begin{defn}
    If $(P,\subseteq)$ is a poset then $A\subseteq P$ is a chain if for all $a,b\in A$ does it hold that $a\subseteq b$. 
\end{defn}
\begin{defn}
    If $(P,\subseteq)$ is a poset then $A\subseteq P$ is a partition if for all $a,b\in A$ does it hold that $a\subseteq b$. 
\end{defn}
\begin{defn}
    If $(P,\subseteq)$ is a poset then $A\subseteq P$ is a partition if for all $a,b\in A$ does it hold that $a\subseteq b$. 
\end{defn}

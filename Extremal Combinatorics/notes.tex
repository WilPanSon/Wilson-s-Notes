...
\end{lem}
\begin{lem}
    Suppose $B$ is a nontrivial $2-(n,r\lambda)$ design, $B$ is on vertex set $V$. $M=A_BA_B^T=(d-\lambda)I+\lambda J$. So the eigenvalues of $M$ are $d+(n-1)\lambda$ with multiplicity $1$ and $d-\lambda$ with multiplicity $n-1$. We can't have $d=\lambda$ as it's just the trivial case. 
\end{lem}
\end{document}
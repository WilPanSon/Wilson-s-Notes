...
\end{proof}
\begin{lem}
    Triangle Removal Lemma: $\forall \epsilon>0, \exists \delta>0$ such that every graph with $\leq \epsilon n^3$ triangles can be made triangle free by deleting only $\delta n^2$ edges. 
\end{lem}
\begin{proof}
    Pick $\epsilon'$
\end{proof}

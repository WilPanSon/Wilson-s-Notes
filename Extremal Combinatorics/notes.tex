...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        The total number of iterations is $\leq \frac{4}{\epsilon^4}$ and $g(k)=k 4^k$. The total number of parts at the end is $\leq \underbrace{g(g(...g_\frac{}{4}{\epsilon^4} \text{ times}}(m))...)$
    \end{enumerate} 
\end{proof}
\end{document}
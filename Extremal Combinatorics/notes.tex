...
\begin{proof}
    ...
    \[
    a_1p_1+...+a_kp_k-b_{k+1}p_{k+1}-...-b_{d+2}p_{d+2}=0
    .\] 
    ...
    \[
    \frac{b_{k+1}}{A}p_{k+1}+\cdots+\frac{b_{d+2}}{A}p_{d+2}
    .\] 
    This is a convex combination of blue points so it's in the convex hull of the blue points. Therefore, the convex hull of the red points is contained in the convex hull of the blue points.
\end{proof}
\end{document}
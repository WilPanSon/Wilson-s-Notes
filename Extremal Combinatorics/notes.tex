...
\begin{proof}
    ...
    So if $0\notin CH(x_{i_1},...,x_{i_{d+1}})$ for any choice of $i_1,...,i_{d+1}$, all choices of $d+1$, $H_i$'s intersect. By Helly, all $H_i$'s intersect. There exist $u, u\cdot x_i>1$ for $i=1,...,M$. But this separates all $x_i$ from $0$ to a hyperplane, contradicitn gthat $0\in$
\end{proof}
\end{document}
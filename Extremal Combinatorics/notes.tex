...
\begin{proof}
    ...
    \leq \underbrace{{ {n \choose 2} \choose \epsilon n^2}}_{ \text{deleted edges}} \cdot \underbrace{(2^n)^k}_{ \text{choices for }V_1,V_2,...,V_k} \cdot \underbrace{2^{ (n/k)^2\cdot e(R)}}_{ \text{choices of edges between regular parts.}}
    .\] 
\end{proof}
\end{document}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item For each $i$ consider all partitions of $V_i$ as $V_i=V_{i,1}\cup V_{i,2}$ and take the common refinement. Two $V,V'$ are in the same part of the refinement iff $V,V'$ are in the same part in ea
    \end{enumerate} 
\end{proof}
\end{document}
...
\begin{proof}
    ...
    Note that $\mathcal{F}'$ is an antichain, if $x,y\in \mathcal{F}\setminus \mathcal{A}$ then $x,y$ are incomparable since $x,y\in \mathcal{F}$. If $x,y\in \partial \mathcal{A}$, then $x,y$ are incomparable since 
\end{proof}
\end{document}
...
\begin{proof}
    ...
    For each $n\leq N$, as $R$ noetherian, $J_n$ is finitely generated ideal of $R$. For each $n\leq N$, choose a finite set $F_n\subseteq I$ such that if $\deg(f)=n$ then $f\in F_n$ and 
\end{proof}
\end{document}
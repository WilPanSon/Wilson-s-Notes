...
\begin{proof}
    ...
    Verify that $N_\infty$ is a submodule of $M$, as $M$ is noetherian, $N_\infty$ is finitely generated say $N_\infty=\Span(X)$ with $X\subseteq N_\infty$ finite. Find $i$ such that $X\subseteq N_i$ then $N_\infty=\Span(X)\subseteq N_i\subseteq N_j$
\end{proof}
\end{document}
...
\begin{defn}
    ...
    \begin{enumerate}
        ...
        \end{tikzcd}
        \]
        \item Naturality in $d$: If $y=g\delta$ commutes then $(g\delta)^*=Gg\,\delta^*$ commutes. 
        \[
        \begin{tikzcd}
            Fc \arrow[r, "\delta"] \arrow[dr, "y"'] & d_1 \arrow[d, "g"] \\
            & d_2
        \end{tikzcd}
        \qquad\Longrightarrow\qquad
        \begin{tikzcd}
            c \arrow[r, "\delta^*"] \arrow[dr, "y^*"'] & d_1 \arrow[d, "\beta"] \\
            & d_2
        \end{tikzcd}
        \]
    \end{enumerate}

...
\begin{proof}
    ...
    So $a=bc$ where $b,c$ not units. So $(a)\subsetneq (b)$ and $(a)\subsetneq (c)$ so $b,c$ are finite products of irreducibles. Contradiction so $a$ is a finite product of irreducibles. 
\end{proof}
\begin{claim}

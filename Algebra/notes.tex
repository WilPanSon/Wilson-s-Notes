...
\begin{proof}
    ...
    .\]
    $\phi^*$ is homomorphism. So $\phi^*(fg)=\phi^*(\phi(f)\phi(g))=\phi(f)\phi(g)$. As $p|fg$ in $R/P[x]$, $p|\phi(f)\phi(g)$ in $R/P[x]$. As $R/P$ is ID, $p|\phi(f)$ or $p|\phi(g)$ in $R/P[x]$. So $p|f$ or $p|g$ in $R[x]$. Contradiction. 
\end{proof}
\end{document}
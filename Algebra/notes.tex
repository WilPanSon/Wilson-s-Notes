...
\section{March 20}
\begin{thm}
    Let $F$ be a finitely genereated module over PID $R$ say $F=Rf_1+\cdots+Rf_t, f_i\in F$. Define $\pi:R^t\to F$ by $\pi:(\lambda_1,...,\lambda_t)\mapsto \sum_{i_=1}^t \lambda_i t_i$. $$
\end{thm}
\end{document}
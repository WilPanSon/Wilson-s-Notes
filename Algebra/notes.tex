...
\end{claim}
\begin{proof}
    If not, choose $a$ that is not a finite product of irreducibles such that $(a)$ is maximal under inclusion, a not finite product of irreducibles. $a$ is not irreducible. So $a=bc$ where $b,c$ not units. So $(a)\subset$
\end{proof}
\end{document}
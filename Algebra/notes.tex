...
\begin{defn}[Natural Transformation]
    Let $F_1,F_2:\mathcal{C}\to \mathcal{D}$. A natural transformation from $F_1\to F_2$ is a family $v=(v_c)$, for $c$ object of $\mathcal{C}$,  $F_1c\xrightarrow{v_c} F_2c$ in $\mathcal{D}$ such that for all $c\xrightarrow{\alpha} c'$ comm
\end{defn}
\end{document}
...
\end{claim}
\begin{proof}
    $u_1$ divides $v_1...v_m$. As $R$ PID, $u_1$ is prime so $u_1 | v_j$ for some $j$. As $v_j$ is irreducible, $u_i$ either unit or an associate of $v_j$. As $u_i$ irreducible, $u_i$ not a unit. So $u_1$ and $v_j$ are associates. Say $u_1=x\cdot v_j$ for $x$ unit. 
\end{proof}
\end{document}
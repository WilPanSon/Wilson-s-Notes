...
\begin{defn}
    ...
    .\] 
    Define $i:M_1\to M_1 \oplus M_2$ by $i(m_1)=(m_1,0)$ and $j:M_2\to M_1 \oplus M_2$ by $j(m_2)=(0,m_2)$. 
    We have $\rho(m_1,m_2)=\rho((m_1,0)+(0,m_2))=\rho(m_1,0)+\rho(0,m_2)=\psi(m_1)+\psi(m_2)$
\end{defn}
\end{document}
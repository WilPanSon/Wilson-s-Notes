...
\end{thm}
\begin{rmk}
    Let $R$ be a ring, $M,N,P$ be $R$-modules. We can view $\phi:M\times N\to P$ bilinear as an element of $Hom(M,Hom(N,P))$. THis is from $\phi(m,-)$ is a linear map from $N$ to $P$. 
\end{rmk}
\end{document}
...
is a coproduct of $c,d$ iff for all cocones
    \begin{center}
        \begin{tikzcd}
            c \arrow[dr, "\alpha"'] \arrow[drr, "\alpha'"'] & & d \arrow[dl, "\beta"] \arrow[dll, "\beta'"] \\
            & e \arrow[d, "\phi", dashed] & \\
            & e' &
        \end{tikzcd}
    \end{center}
    there is a unique $\phi: e \to e'$ such that the diagram commutes (i.e.\ $\alpha' \circ \phi = \alpha$ and $\beta' \circ \phi = \beta$).
\end{defn}
\end{document}
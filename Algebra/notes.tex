...
\begin{proof}
    ...
    (Base Case) $h=0$, $\deg(h)\leq N$ and $h=rx^n+\sum_{in}c_ix^i$ where $r\in J_n$. SO find $\lambda_1,...,\lambda_t\in R$ and $g_1,...,g_t\in F_n$ such that $r= \text{leading coefficient of } \sum_{i=1}^t \lambda_i g_i$. Look at $h-\sum_{i=1}^t\lambda_i g_i$ i
\end{proof}
\end{document}
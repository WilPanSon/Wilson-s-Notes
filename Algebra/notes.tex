...
\begin{eg}
    ...
    \begin{enumerate}
        ...
        \item $ \{f: \R\to \R \text{ integrable}\}$
        \item $ \{f: \R\to \R \text{ continuous and integrable}\}$
        \item $ \{f: \R\to \R \text{ continuous and differentiable}\}$
        \item $ \{f: \R\to \R \text{ continuous and integrable and differentiable}\}$
        \item $ \{f: \R\to \R \text{ continuous and integrable and differentiable and continuous and integrable and differentiable}\}$
        \item $ \{f: \R\to \R \text{ continuous and integrable and differentiable and continuous and integrable and differentiable and continuous and integrable and differentiable}\}$
    \end{enumerate}
\end{eg}

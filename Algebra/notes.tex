...
\end{defn}
\begin{eg}
        Groups: Let $G_1,G_2,H$ be groups and $\rho:H\to G_1\times G_2$ by $\rho(h)=(\phi(h),\psi(h))$ and $\pi_1(g_1,g_2)=g_1$ and $\pi_2(g_1,g_2)=g_2$. 
        \begin{center}
            \begin{tikzcd}
                H \arrow[r, "\rho"] & G_1\times G_2 \\
                & \pi_1 \arrow[u, "\pi_1"] \arrow[u, "\pi_2"']
            \end{tikzcd}
        \end{center}
        The diagram commutes because $\pi_1(\rho(h))=\pi_1(\phi(h),\psi(h))=\phi(h)$ and $\pi_2(\rho(h))=\pi_2(\phi(h),\psi(h))=\psi(h)$. \\
        The cone is a product of $G_1$ and $G_2$ because for any cone 
        \begin{center}
\end{eg}
\end{document}
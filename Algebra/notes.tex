...
\end{thm}
\newpage
\section{Lecture 14: Zorn's Lemma and Maximal Ideals (Feb 13)}
\begin{lem}
    Zorn's Lemma: If $\mathbb{P}$ is a poset such that every chain in $\mathbb{P}$ has an upper bound, then for every element $p$ of $\mathbb{P}$ there is a $q\geq p$ with $$
\end{lem}
\end{document}
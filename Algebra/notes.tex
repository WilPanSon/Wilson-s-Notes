...
\begin{defn}
    ...
    \begin{center}
        ...
        \end{tikzcd}
    \end{center}
    there is a unique $e'\xrightarrow{\phi} e$ such that the diagram 
    \begin{center}
        \begin{tikzcd}
...
\end{defn}
\begin{eg}
    Groups: Let $G_1,G_2,H$ be groups and $\rho:H\to G_1\times G_2$ by $\rho(h)=(\phi(h),\psi(h))$ and $\pi_1(g_1,g_2)=g_1$ and $\pi_2(g_1,g_2)=g_2$. Then $\rho$ is a cone over $G_1,G_2$ and $\pi_1,\pi_2$ are the unique morphisms such that the diagram commutes. 
\end{eg}
\end{document}
...
\end{proof}
\begin{proof}
    To show 1, of lemma 24.3, by induction on rank of $M$ with $N$ fixed, Suppose $1$ have it for submodules of $N$ of smaller rank. Using our basic construction, $M$ is decomposed into $Ry$ and $\ker(\psi)\cap M$. It's easy to see that $\ker(\psi)\cap M$
\end{proof}
\end{document}
...
\begin{defn}[Universal Property of Tensor Products]
...
\begin{proof}
    ...
    \end{thm}
    There is a basis $z_1,...,z_n$ of $N$ and there are nonzero nonunit $c_1,...,c_m$ such that $c_i$ divides $c_{i+1}$ and $c_1z_1,...,c_mz_m$ forms a basis of $M$. 
\end{proof}
\end{document}
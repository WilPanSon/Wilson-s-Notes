...
\end{lem}
\begin{proof}
    To show existence of factorization: Let $f\in R[x]$ nonzero and nonunit. Write $f=cg$ where $c\in R$ and $g\in R[x]$ primitive. If $C$ nonunit (in $R$), use $R$ being UFD to write $c=r_1...r$
\end{proof}
\end{document}
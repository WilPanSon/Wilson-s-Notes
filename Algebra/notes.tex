...
\end{proof}
\begin{defn}
    Let $R$ be a ring. A $R$-module is an abelian group $M$ with a map $R\times M\to M$ such that $r(m+n)=rm+rn$ and $(r+s)m=rm+sm$ and $r(sm)=(rs)m$ for all $r,s\in R$ and $m,n\in M$.
\end{defn}
\end{document}
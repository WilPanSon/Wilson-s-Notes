...
\end{thm}
\begin{proof}
    Let $R$ be euclidean domain and let $I$ be the ideal of $R$. If $I=0$ then we're done. If $I\neq 0$ consider $ \left\{\phi(r)|r\in I, r\neq 0\right\}\subseteq \N$. Let $n$ be the minimal element and let $a\in I\setminus \{0\}$ such that $\phi(a)=n$. As $a\in I, Ra\subseteq I$. Let $b\in I,$ find $q,r$ such that $b=aq+r$ either $r=0$ or $\phi(r)<\phi(a)$. We have $r=b-aq\in I$ 
\end{proof}
\end{document}
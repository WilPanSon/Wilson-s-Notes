...
\end{thm}
\begin{rmk}
    Let $R$ be a ring, $M,N,P$ be $R$-modules. We can view $\phi:M\times N\to P$ bilinear as an element of $Hom(M,Hom(N,P))$. This is from $\phi(m,-)$ is a linear map from $N$ to $P$ and $m\mapsto \phi(m,-)$ is a linear map from $M$ to $Hom(N,P)$. This is an element of $Hom(M,Hom(N,P))$. 
\end{rmk}
\end{document}
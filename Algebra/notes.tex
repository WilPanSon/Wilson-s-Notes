...
\end{lem}
\begin{proof}
    Let $a \xrightarrow{f} b$ and $b \xrightarrow{g} a$ be unique arrows from $a$ to $b$ and $b$ to $a$ respectively. Then we have $a \xrightarrow{gf} a$ and $b \xrightarrow{fg} b$. Since $a$ and $b$ are initial, $gf=1_a$ and $fg=1_b$. Thus, $a \simeq b$.
\end{proof}
\end{document}